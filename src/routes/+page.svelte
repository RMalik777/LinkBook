...
<header
	class="mt-20 mb-10 flex flex-col items-center justify-center gap-3 overflow-hidden border border-purple-200/80 px-4 py-8 shadow-xs backdrop-blur-md backdrop-saturate-150 sm:mt-24 sm:mb-12 sm:gap-4 dark:border-purple-900/50"
>
...
<main class="flex w-dvw max-w-full min-w-fit flex-col items-center gap-4 px-4 sm:px-0">
	{#each LinkData as link, index (link.url)}
		<a
			class="group relative flex w-full flex-col border border-purple-200/80 bg-transparent px-4 py-2 text-sm shadow-xs backdrop-blur-xs backdrop-saturate-150 duration-200 ease-out hover:shadow-sm focus-visible:shadow-sm sm:w-1/2 sm:text-base lg:w-2/5 dark:border-purple-900/50 dark:text-white starting:translate-y-40"
		...
		>
			...
			<div
				class="gradient absolute inset-0 z-2 h-full w-full bg-linear-to-r/oklch from-purple-100 to-violet-100 opacity-0 transition duration-150 ease-in-out group-hover:opacity-100 group-focus-visible:opacity-100 dark:from-purple-900/10 dark:to-violet-950/50"
			></div>

			<div class="background absolute inset-0 z-1 h-full w-full bg-white dark:bg-neutral-950"></div>
			<div
